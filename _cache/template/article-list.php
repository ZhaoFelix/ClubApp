		...
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td><?php echo $c+1;?></td>
					<td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="article_edit('查看','metting-detail.php?newsid=<?php e($data['NewsId']);?>','10001')" title="查看"><?php e($data["Title"]);?></u></td>
					<td><?php e($data["Publishor"]);?></td>
					<td><?php e($data["PublishTime"]);?></td>
					<td>21212</td>
