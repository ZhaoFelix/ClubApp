	...
	function($){
		$.extend({
				"easypage":function(options){
					...
					//拼接导航按钮
					var navigatehtml = "<div id='pagefirst' class='pagefirst'><a href='javascript:void(0)' class='fa fa-angle-double-left'></a></div><div id='pagepre' class='pagepre'><a href='javascript:void(0)' class='fa fa-angle-left'></a></div>";
					for(var i = 1;i <= pagecount;i++){
							navigatehtml+='<div class="pagenavigate"><a href="javascript:void(0)">'+i+'</a></div>';
					}
					navigatehtml+="<div id='pagenext' class='pagenext'><a href='javascript:void(0)' class='fa fa-angle-right'></a></div><div id='pagelast' class='pagelast'><a href='javascript:void(0)' class='fa fa-angle-double-right'></a></div>";
