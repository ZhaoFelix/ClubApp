...
///// LMS Alerts
function LMSAlert(a, b) {
    var c = "<style>#_alertbox{transition: all .1s ease-out;transform: scale(0.9);} ._obbutton{ background-color: #b00;}._obbutton:hover{  }._obbutton:active{ background-color: #b00; }</style>",
    d = "<div id='_alertview' style='z-index:999999;display:none;background-color:rgba(0,0,0,0.6);width:100%;height:100%;position:fixed;top:0px;'>     <div id='_alertbox' style='box-shadow: 0px 0px 50px #444; border-radius: 3px;width:299px;padding:15px;background: linear-gradient(180deg, #fff, #eee);margin:auto;margin-top: 100px;'>         <div id='_alerttext' style='text-align:center;padding-top:15px;padding-bottom: 20px;color:black;'>" + a + "</div>" + "         <div class='blue-button _obbutton' id='_obbutton' style='cursor:default;border-radius: 3px; line-height: 35px;width:100px;height:35px;margin:auto;color:white;text-align: center;'>" + l("确定|OK") + "</div>" + "     </div>" + "</div>";
    document.getElementById("#_alertview") || $(document.body).append(c + d),
    $("#_alerttext").html(a),
    $("#_alertview").fadeIn(50),
    $("#_alertbox").css("transform", "scale(1)"),
    setTimeout(function() {
        $("#_alertbox").css("width", "300px")
    },
    .2),
    document.getElementById("_obbutton").onclick = function() {
        b && b(),
        $("#_alertview").fadeOut(100),
        $("#_alertbox").css("transform", "scale(0.9)"),
        $("#_alertbox").css("width", "299px")
    }
}
function confirm(a, b, c) {
    var d = "<style>#_confirmbox{transition: all .1s ease-out;transform: scale(0.9);} ._donebutton,._cancelbutton{ background-color: #bb0000; } ._cancelbutton:hover,._donebutton:hover{  } ._cancelbutton:active,._donebutton:active{ background-color: #b00; }</style>",
    e = "<div id='_confirmview' style='z-index:999999;display:none;background-color:rgba(0,0,0,0.6);width:100%;height:100%;position:fixed;top:0px;'>     <div id='_confirmbox' style='box-shadow: 0px 0px 50px #444; border-radius: 3px;width:329px;padding:15px;padding-bottom:50px;background: linear-gradient(180deg, #fff, #eee);margin:auto;margin-top: 100px;'>         <div id='_confirmtext' style='text-align:center;padding-top:15px;padding-bottom: 20px;color:black;'>" + a + "</div>" + "         <div id='_donebutton' class='blue-button _donebutton' style='cursor:default;border-radius: 3px; line-height: 35px;width:100px;height:35px;float:left;margin-left:40px;color:white;text-align: center;'>" + l("是|Yes") + "</div>" + "         <div id='_cancelbutton' class='blue-button _cancelbutton' style='cursor:default;border-radius: 3px; line-height: 35px;width:100px;height:35px;float:right;margin-right:40px;color:white;text-align: center;' >" + l("否|No") + "</div>" + "     </div>" + "</div>";
    document.getElementById("#_confirmview") || $(document.body).append(d + e),
    $("#_confirmtext").html(a),
    $("#_confirmview").fadeIn(50),
    $("#_confirmbox").css("transform", "scale(1)"),
    setTimeout(function() {
        $("#_confirmbox").css("width", "330px")
    },
    .2),
    document.getElementById("_donebutton").onclick = function() {
        b && b(),
        $("#_confirmbox").css("width", "329px"),
        $("#_confirmview").fadeOut(100),
        $("#_confirmbox").css("transform", "scale(0.9)")
    },
    document.getElementById("_cancelbutton").onclick = function() {
        c && c(),
        $("#_confirmbox").css("width", "329px"),
        $("#_confirmview").fadeOut(100),
        $("#_confirmbox").css("transform", "scale(0.9)")
...
function toast(a, b, c) {
    var d, e;
    c || (c = 1e3),
    d = "left:50%;margin-left:-165px;top:37%;",
    "TopLeft" === b ? d = "left:15px;top:15px;": "TopCenter" === b ? d = "left:50%;margin-left:-165px;top:15px;": "TopRight" === b ? d = "right:15px;top:15px;": "MiddleLeft" === b ? d = "left:15px;top:37%;": "MiddleCenter" === b ? d = "left:50%;margin-left:-165px;top:37%;": "MiddleRight" === b ? d = "right:15px;top:37%;": "BottomLeft" === b ? d = "left:15px;bottom:15px;": "BottomCenter" === b ? d = "left:50%;margin-left:-165px;bottom:15px;": "BottomRight" === b && (d = "right:15px;bottom:15px;"),
    e = "<div id='_toast' style='left:0px;top:0px;display:none;position:fixed;z-index:999999;width:100%;height:100%;'><div id='_toasttext' style='" + d + "position:absolute;text-align:center;width:330px;padding:15px;border-radius:3px;box-shadow:0px 0px 5px #555;background-color:white;color:black;font-size:16px;'>" + a + "</div></div>",
    document.getElementById("#_toast") || $(document.body).append(e),
    $("#_toasttext").html(a),
    $("#_toast").fadeIn(50),
    setTimeout(function() {
        $("#_toast").fadeOut(100)
...
function l(langText){
    var langTextPart = langText.split("|");
    if(lang == "cn"){
        return langTextPart[0];
    }else if(lang == "en"){
        if(langTextPart.length>1){
            return langTextPart[1];
        }
    }
    return "";
}
