...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20" style="margin-bottom: 20px;"> <span class="l"><a href="javascript:;" onclick="admin_add('添加管理员','add-member-admin.php','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span> <span class="r">共有数据：<strong>{$count} </strong> 条</span> </div>
