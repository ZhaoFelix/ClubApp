...
<div class="page-container">
	<div class="text-c">
	 ...
	 <span class="select-box inline">
		...
		<input type="text" onfocus="WdatePicker({ maxDate:'#F<?php echo $dp.$D(\'logmax\')||\'%y-%M-%d\';?>' })" id="logmin" class="input-text Wdate" style="width:120px;">
		-
		<input type="text" onfocus="WdatePicker({ minDate:'#F<?php e($dp.$D(\'logmin\'));?>',maxDate:'%y-%M-%d' })" id="logmax" class="input-text Wdate" style="width:120px;">
