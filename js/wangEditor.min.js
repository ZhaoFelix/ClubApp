...
function(a) {
    ...
    return function(a, b) {
        ...
        c.getComputedStyle = a.getComputedStyle,
        c.w3cRange = "function" == typeof document.createRange,
        c.hostname = location.hostname.toLowerCase(),
        c.websiteHost = "wangeditor.github.io|www.wangeditor.com|wangeditor.coding.me",
        c.isOnWebsite = c.websiteHost.indexOf(c.hostname) >= 0,
        c.docsite = "http://www.kancloud.cn/wangfupeng/wangeditor2/113961",
        a.wangEditor = c,
        c.plugin = function(a) {
            c._plugins || (c._plugins = []),
            "function" == typeof a && c._plugins.push(a)
        }
    } (window, a),
    b(function(a, b) {
        a.fn.init = function() {
    ...
    b(function(a, b) {
        a.fn.ready = function(a) {
            this.readyFns || (this.readyFns = []),
            this.readyFns.push(a)
        },
        ...
        a.fn.getInitValue = function() {
            ...
            c = "",
            d = a.valueNodeName;
            return "div" === d ? c = b.html() : "textarea" === d && (c = b.val()),
            c
        },
        ...
        a.fn.enableMenusExcept = function(a) {
            this._disabled || (a = a || [], "string" == typeof a && (a = [a]), b.each(this.menus,
            function(b, c) {
    ...
    b(function(a, b) {
        ...
        a.fn.collapseRange = function(a, b) {
            ...
            a && (a.collapse(b), this.currentRange(a))
        },
        ...
        a.fn.isRangeEmpty = d ? c: function(a) {
            return a = a || this.currentRange(),
            !(!a || !a.startContainer || a.startContainer !== a.endContainer || a.startOffset !== a.endOffset)
        },
        a.fn.saveSelection = d ? c: function(a) {
            var c, d, e = this,
            f = e.txt.$txt.get(0);
            a ? c = a.commonAncestorContainer: (d = document.getSelection(), d.getRangeAt && d.rangeCount && (a = document.getSelection().getRangeAt(0), c = a.commonAncestorContainer)),
            c && (b.contains(f, c) || f === c) && e.currentRange(a)
        },
        ...
        a.fn.setRangeByElem = d ? c: function(a) {
            ...
            if (a && b.contains(d, a)) {
                ...
                e && f ? (g.setStart(e, 0), g.setEnd(f, f.textContent.length)) : (g.setStart(a, 0), g.setEnd(a, 0)),
                c.saveSelection(g)
            }
        }
    }),
    b(function(a, b) {
        ...
        a.fn.saveSelection = function(a) {
            var c, d = this,
            e = d.txt.$txt.get(0);
            a ? c = a.parentElement() : (a = document.selection.createRange(), c = "undefined" == typeof a.parentElement ? null: a.parentElement()),
            c && (b.contains(e, c) || e === c) && d.currentRange(a)
        },
        a.fn.restoreSelection = function(a) {
            ...
            if (a = a || c.currentRange()) {
                ...
                if (0 === a.text.length) try {
                    b.collapse(!1)
                } catch(d) {} else b.setEndPoint("StartToStart", a);
                b.select()
            }
        })
    }),
    ...
    b(function(a, b) {
        ...
        a.fn.commandForElem = function(a, b, c, d, e) {
            ...
            h = this.getSelfOrParentByName(h, f, g),
            h && this.setRangeByElem(h),
            this.command(b, c, d, e)
        },
    ...
    b(function(a, b) {
        ...
        a.fn.getSelfOrParentByName = function(a, e, f) {
            if (a && e) {
                d || (d = a.webkitMatchesSelector || a.mozMatchesSelector || a.oMatchesSelector || a.matchesSelector),
                d || (d = c);
    ...
    b(function(a, b) {
        function c(a) {
            return null == a._redoList && (a._redoList = []),
            a._redoList
        }
        function d(a) {
            return null == a._undoList && (a._undoList = []),
            a._undoList
        }
        function e(a, b, c) {
            var d = b.val,
            ...
            if (null != d) {
                ...
                a.txt.$txt.html(d),
                a.updateValue(),
                a.onchange && "function" == typeof a.onchange && a.onchange.call(a)
            }
        }
        var f = 20;
    ...
    b(function(a, b) {
        a.fn.create = function() {
            var c = this;
            a.$body && 0 !== a.$body.length || (a.$body = b("body"), a.$document = b(document), a.$window = b(window)),
            c.addMenus(),
            c.renderMenus(),
            c.renderMenuContainer(),
            c.renderTxt(),
            c.renderEditorContainer(),
            c.eventMenus(),
            c.eventMenuContainer(),
            c.eventTxt(),
            c.readyHeadler(),
            c.initSelection(),
            c.$txt = c.txt.$txt;
        ...
        a.fn.clear = function() {
            ...
            b = a.txt.$txt;
            b.html("<p><br></p>"),
            a.restoreSelectionByElem(b.find("p").get(0))
        }
    }),
    b(function(a, b) {
        var c = function(a) {
    ...
    b(function(a, b) {
        ...
        c.fn.init = function() {
            var a = this,
            c = b('<div class="wangEditor-menu-container clearfix"></div>');
            a.$menuContainer = c,
            a.changeShadow()
        },
    ...
    b(function(a, b) {
        var c = function(a) {
            ...
            this.id = a.id,
            this.title = a.title,
            this.$domNormal = a.$domNormal,
            this.$domSelected = a.$domSelected || a.$domNormal,
            this.commandName = a.commandName,
            this.commandValue = a.commandValue,
            this.commandNameSelected = a.commandNameSelected || a.commandName,
            this.commandValueSelected = a.commandValueSelected || a.commandValue
        };
        c.fn = c.prototype,
        a.Menu = c
    }),
    b(function(a, b) {
        ...
        c.fn.initUI = function() {
            ...
            e = this.id,
            f = d[e];
            this.$domNormal && this.$domSelected || (null == f && (a.warn('editor.UI配置中，没有菜单 "' + e + '" 的UI配置，只能取默认值'), f = d.
        default), this.$domNormal = b(f.normal), /^\./.test(f.selected) ? this.$domSelected = this.$domNormal.clone().addClass(f.selected.slice(1)) : this.$domSelected = b(f.selected))
        }
    }),
    b(function(a, b) {
        var c = a.Menu;
        ...
        c.fn._renderTip = function(c) {
            ...
            g.tipWidth || (f = b('<p style="opacity:0; filter:Alpha(opacity=0); position:absolute;top:-10000px;">' + i + "</p>"), a.$body.append(f), h.ready(function() {
                var a = f.outerWidth() + 5,
                b = j.outerWidth(),
                c = parseFloat(j.css("margin-left"), 10);
                f.remove(),
                f = null,
                j.css({
                    width: a,
        ...
        c.fn.bindEvent = function() {
            ...
            e || (e = function(c) {
                ...
                var e, f, g = b.editor,
                h = b.selected;
                h ? (e = b.commandNameSelected, f = b.commandValueSelected) : (e = b.commandName, f = b.commandValue),
                e ? g.command(c, e, f) : (a.warn('菜单 "' + b.id + '" 未定义click事件'), c.preventDefault())
            });
            var f = b.clickEventSelected || e;
            c.click(function(a) {
                b.disabled() || (e.call(b, a), b.updateSelected()),
                a.preventDefault()
            }),
            d.click(function(a) {
                b.disabled() || (f.call(b, a), b.updateSelected()),
                a.preventDefault()
            })
        },
        c.fn.updateSelected = function() {
            var a = this,
            b = (a.editor, a.updateSelectedEvent);
            b || (b = function() {
                var a = this,
                b = a.editor,
                c = a.commandName,
        ...
        c.fn.changeSelectedState = function(a) {
            ...
            if (null != a && "boolean" == typeof a) {
                if (c === a) return;
                b.selected = a,
                a ? (b.$domNormal.hide(), b.$domSelected.show()) : (b.$domNormal.show(), b.$domSelected.hide())
            }
        },
        ...
        c.fn.activeStyle = function(a) {
            var b = (this.selected, this.$domNormal),
            c = this.$domSelected;
            a ? (b.addClass("active"), c.addClass("active")) : (b.removeClass("active"), c.removeClass("active")),
            this.active(a)
        },
        c.fn.disabled = function(a) {
            if (null == a) return !! this._disabled;
            if (this._disabled !== a) {
                var b = this.$domNormal,
                c = this.$domSelected;
                a ? (b.addClass("disable"), c.addClass("disable")) : (b.removeClass("disable"), c.removeClass("disable")),
                this._disabled = a
            }
        }
    }),
    b(function(a, b) {
        var c = function(a, b, c) {
            ...
            this.data = c.data,
            this.tpl = c.tpl,
            this.selectorForELemCommand = c.selectorForELemCommand,
            this.beforeEvent = c.beforeEvent,
            this.afterEvent = c.afterEvent,
            this.init()
        };
        c.fn = c.prototype,
        a.DropList = c
    ...
    b(function(a, b) {
        ...
        c.fn.initDOM = function() {
            var a, c, d = this,
            e = d.data,
            f = d.tpl || "<span>{#title}</span>",
            g = b('<div class="wangEditor-drop-list clearfix"></div>');
            b.each(e,
            function(d, e) {
                a = f.replace(/{#commandValue}/gi, d).replace(/{#title}/gi, e),
                c = b('<a href="#" commandValue="' + d + '"></a>'),
                c.append(a),
                g.append(c)
            }),
            d.$list = g
        ...
        c.fn.bindEvent = function() {
            ...
            d = a.menu,
            e = d.commandName,
            f = a.selectorForELemCommand,
            g = a.$list,
            h = a.beforeEvent,
            i = a.afterEvent;
            g.on("click", "a[commandValue]",
            function(a) {
                h && "function" == typeof h && h.call(a);
                var g = b(a.currentTarget).attr("commandValue");
                d.selected && c.isRangeEmpty() && f ? c.commandForElem(f, a, e, g) : c.command(a, e, g),
                i && "function" == typeof i && i.call(a)
            })
        },
        c.fn.initHideEvent = function() {
            ...
            function(a) {
                if (c.isShowing) {
                    var e, f = a.target,
                    g = c.menu;
                    e = g.selected ? g.$domSelected.get(0) : g.$domNormal.get(0),
                    e === f || b.contains(e, f) || d === f || b.contains(d, f) || c.hide()
                }
            }),
    ...
    b(function(a, b) {
        ...
        c.fn._position = function() {
            ...
            c = a.editor,
            d = a.menu,
            e = c.menuContainer.$menuContainer,
            f = d.selected ? d.$domSelected: d.$domNormal,
            g = f.offsetParent().position(),
            h = g.top,
            i = g.left,
            j = f.offsetParent().height(),
            k = f.offsetParent().width(),
            l = b.outerWidth(),
            m = c.txt.$txt.outerWidth(),
            n = h + j,
            o = i + k / 2,
            p = 0 - k / 2,
            q = o + l - m;
            ...
            c._isMenufixed && (n += e.offset().top + e.outerHeight() - b.offset().top, b.css({
                top: n
            }))
        },
        c.fn.show = function() {
    ...
    b(function(a, b) {
        ...
        c.fn.initDOM = function() {
            ...
            d = a.width,
            e = a.height,
            f = b('<div class="wangEditor-drop-panel clearfix"></div>'),
            g = b('<div class="tip-triangle"></div>');
            f.css({
                width: d,
                height: e ? e: "auto"
            }),
    ...
    b(function(a, b) {
        ...
        c.fn._position = function() {
            ...
            c = a.$triangle,
            d = a.editor,
            e = d.menuContainer.$menuContainer,
            f = a.menu,
            g = f.selected ? f.$domSelected: f.$domNormal,
            h = g.offsetParent().position(),
            i = h.top,
            j = h.left,
            k = g.offsetParent().height(),
            l = g.offsetParent().width(),
            m = b.outerWidth(),
            n = d.txt.$txt.outerWidth(),
            o = i + k,
            p = j + l / 2,
            q = 0 - m / 2,
            r = q;
            ...
            d._isMenufixed && (o += e.offset().top + e.outerHeight() - b.offset().top, b.css({
                top: o
            })),
            c.css({
                "margin-left": r - q - 5
        ...
        c.fn.focusFirstInput = function() {
            ...
            c.find("input[type=text],textarea").each(function() {
                var a = b(this);
                if (null == a.attr("disabled")) return a.focus(),
                !1
            })
        },
        c.fn.show = function() {
            ...
            if (b.rendered || b._render(), !b.isShowing) {
                ...
                b.isShowing = !0,
                c.activeStyle(!0),
                a.w3cRange ? b.focusFirstInput() : a.placeholderForIE8(d)
            }
        },
        c.fn.hide = function() {
            var a = this,
    ...
    b(function(a, b) {
        ...
        c.fn.initDom = function() {
            var a = this,
            c = a.$content,
            d = b('<div class="wangEditor-modal"></div>'),
    ...
    b(function(a, b) {
        ...
        c.fn._render = function() {
            ...
            c = b.editor,
            d = b.$modal;
            d.css("z-index", c.config.zindex + 10 + ""),
            a.$body.append(d),
            b.rendered = !0
        },
        c.fn._position = function() {
    ...
    b(function(a, b) {
        ...
        c.fn.init = function() {
            ...
            e = d.$valueContainer,
            f = d.getInitValue();
            "DIV" === e.get(0).nodeName ? (a = e, a.addClass("wangEditor-txt"), a.attr("contentEditable", "true")) : a = b('<div class="wangEditor-txt" contentEditable="true">' + f + "</div>"),
            d.ready(function() {
                c.insertEmptyP()
            }),
            c.$txt = a,
            c.contentEmptyHandle(),
            c.bindEnterForDiv(),
            c.bindEnterForText(),
            c.bindTabEvent(),
            c.bindPasteFilter(),
        ...
        c.fn.bindEnterForDiv = function() {
            ...
            var d, e = (a.config.legalTags, this),
            f = e.editor,
            g = e.$txt;
            g.on("keydown keyup",
            function(a) {
                if (13 === a.keyCode) {
                    var e, g, h = f.getRangeElem(),
                    i = f.getLegalTags(h);
                    if (!i) {
                        if (i = f.getSelfOrParentByName(h, "div"), !i) return;
                        e = b(i),
                        "keydown" === a.type && (d = e, setTimeout(c, 0)),
                        "keyup" === a.type && (g = b("<p>" + e.html() + "</p>"), e.after(g), e.remove(), f.restoreSelectionByElem(g.get(0), "start"))
                    }
                }
            })
        },
        ...
        c.fn.bindPasteFilter = function() {
            function a(e) {
                if (e && e.nodeType && e.nodeName) {
                    var f, h, i = e.nodeName.toLowerCase(),
                    k = e.nodeType;
                    if (3 === k || 1 === k) {
                        if (f = b(e), "div" === i) return h = [],
                        b.each(e.childNodes,
                        function(a, b) {
                            h.push(b)
                        }),
                        ...
                        if (j.indexOf(i) >= 0) g += c(e);
                        else if (3 === k) g += "<p>" + e.textContent + "</p>";
                        else if ("br" === i) g += "<br/>";
                        else {
                            if (["meta", "style", "script", "object", "form", "iframe", "hr"].indexOf(i) >= 0) return;
                            f = b(d(e)),
                            g += b("<div>").append(f.clone()).html()
                        }
                    }
                }
            }
            function c(a) {
                var c, e = a.nodeName.toLowerCase(),
                f = "",
                g = "";
                return ["blockquote"].indexOf(e) >= 0 ? (c = b(a), "<" + e + ">" + c.text() + "</" + e + ">") : ["p", "h1", "h2", "h3", "h4", "h5"].indexOf(e) >= 0 ? (a = d(a), c = b(a), f = c.html(), f = f.replace(/<.*?>/gi,
                function(a) {
            ...
            function d(a) {
                var c = a.attributes || [],
                e = [],
                f = ["href", "target", "src", "alt", "rowspan", "colspan"];
                b.each(c,
                function(a, b) {
            ...
            function(c) {
                if (f.config.pasteFilter) {
                    ...
                    if ("TD" !== d && "TH" !== d) {
                        g = "";
                        var h, i, j, k = c.clipboardData || c.originalEvent.clipboardData,
                        l = window.clipboardData;
                        if (f.config.pasteText) {
                            if (k && k.getData) h = k.getData("text/plain");
                            else {
                                if (!l || !l.getData) return;
                                h = l.getData("text")
                            }
                            h && (g = "<p>" + h + "</p>")
                        } else if (k && k.getData) h = k.getData("text/html"),
                        j = h.split("</html>"),
                        2 === j.length && (h = j[0]),
                        h ? (i = b("<div>" + h + "</div>"), a(i.get(0))) : (h = k.getData("text/plain"), h && (h = h.replace(/[ ]/g, "&nbsp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/\n/g, "</p><p>"), g = "<p>" + h + "</p>", g = g.replace(/<p>(https?:\/\/.*?)<\/p>/gi,
                        function(a, b) {
        ...
        c.fn.bindFormatText = function() {
            ...
            g.push(new RegExp(">\\s*<(li)>", "ig")),
            g.push(new RegExp(">\\s*<(tr)>", "ig")),
            g.push(new RegExp(">\\s*<(code)>", "ig")),
            d.formatText = function() {
                var a = b("<div>"),
                c = d.html();
                return c = c.replace(/\s*</gi, "<"),
                b.each(g,
                function(a, b) {
                    b.test(c) && (c = c.replace(b,
                    function(a, b) {
                        return ">\n<" + b + ">"
                    }))
                }),
        ...
        c.fn.bindHtml = function() {
            ...
            d.html = function(a) {
                var c;
                return "div" === f && (c = b.fn.html.call(d, a)),
                void 0 === a ? (c = b.fn.html.call(d), c = c.replace(/(href|src)\=\"(.*)\"/gim,
                function(a, b, c) {
                    return b + '="' + c.replace("&amp;", "&") + '"'
                })) : (c = b.fn.html.call(d, a), e.val(a)),
                void 0 === a ? c: void d.change()
            }
        }
    }),
    b(function(a, b) {
        var c = a.Txt,
        d = "propertychange change click keyup input paste";
        c.fn.render = function() {
            var a = this.$txt,
            b = this.editor.$editorContainer;
            b.append(a)
        ...
        c.fn.initHeight = function() {
            var a = this.editor,
            b = this.$txt,
            c = a.$valueContainer.height(),
            d = a.menuContainer.height(),
            e = c - d;
            e = e < 50 ? 50 : e,
            b.height(e),
            a.valueContainerHeight = c,
            this.initMaxHeight(e, d)
        },
        c.fn.initMaxHeight = function(c, d) {
            var e = this.editor,
            f = e.menuContainer.$menuContainer,
            g = this.$txt,
            h = b("<div>");
        ...
        c.fn.wrapImgAndText = function() {
            ...
            3 === c.nodeType && c.textContent && b.trim(c.textContent) && b(c).wrap("<p>")
        },
        ...
        c.fn.showHeightOnHover = function() {
            function a(a) {
                i || (e.append(h), i = !0);
                var b = (g.position().top, g.outerHeight(), a.height()),
                c = a.position().top,
                d = parseInt(a.css("margin-top"), 10),
                j = parseInt(a.css("padding-top"), 10),
                k = parseInt(a.css("margin-bottom"), 10),
                l = parseInt(a.css("padding-bottom"), 10);
                c + f.height();
                h.css({
                    height: b + j + d + l + k,
                    top: c + f.height()
            ...
            f = d.menuContainer,
            g = this.$txt,
            h = b('<i class="height-tip"><i>'),
            i = !1;
            g.on("mouseenter", "ul,ol,blockquote,p,h1,h2,h3,h4,h5,table,pre",
            function(c) {
                a(b(c.currentTarget))
            }).on("mouseleave",
            function() {
    ...
    b(function(a, b) {
        ...
        a.placeholder = "placeholder" in document.createElement("input"),
        a.placeholderForIE8 = function(c) {
            a.placeholder || c.find("input[placeholder]").each(function() {
                var a = b(this),
                c = a.attr("placeholder");
                "" === a.val() && (a.css("color", "#666"), a.val(c), a.on("focus.placeholder click.placeholder",
                function() {
                    a.val(""),
                    a.css("color", "#333"),
                    a.off("focus.placeholder click.placeholder")
                }))
            })
        }
    }),
    ...
    b(function(a, b) {
        ...
        a.config.zindex = 1e4,
        a.config.printLog = !0,
        a.config.menuFixed = 0,
        a.config.jsFilter = !0,
        a.config.legalTags = "p,h1,h2,h3,h4,h5,h6,blockquote,table,ul,ol,pre",
        a.config.lang = a.langs["zh-cn"],
        a.config.menus = ["source", "|", "bold", "underline", "italic", "strikethrough", "eraser", "forecolor", "bgcolor", "|", "quote", "fontfamily", "fontsize", "head", "unorderlist", "orderlist", "alignleft", "aligncenter", "alignright", "|", "link", "unlink", "table", "emotion", "|", "img", "video", "location", "insertcode", "|", "undo", "redo", "fullscreen"],
        a.config.colors = {
            "#880000": "暗红色",
            "#800080": "紫色",
            "#ff0000": "红色",
        ...
        a.config.familys = ["宋体", "黑体", "楷体", "微软雅黑", "Arial", "Verdana", "Georgia", "Times New Roman", "Microsoft JhengHei", "Trebuchet MS", "Courier New", "Impact", "Comic Sans MS", "Consolas"],
        a.config.fontsizes = {
            1 : "12px",
            2 : "13px",
            3 : "16px",
        ...
        a.config.mapAk = "TVhjYjq1ICT2qqL5LdS8mwas",
        a.config.uploadImgUrl = "",
        a.config.uploadTimeout = 2e4,
        a.config.uploadImgFns = {},
        a.config.customUpload = !1,
        a.config.uploadParams = {},
        a.config.uploadHeaders = {},
        a.config.withCredentials = !0,
        a.config.hideLinkImg = !1,
        a.config.pasteFilter = !0,
        a.config.pasteText = !1,
        a.config.codeDefaultLang = "javascript"
    }),
    b(function(a, b) {
        a.UI = {},
        a.UI.menus = {
    ...
    b(function(a, b) {
        a.createMenu(function(c) {
            ...
            if (c(d)) {
                ...
                i.on("click", "a[commandValue]",
                function(a) {
                    var c = b(this),
                    d = c.attr("commandValue");
                ...
                h.updateSelectedEvent = function() {
                    ...
                    return a = e.getSelfOrParentByName(a, "font[color]"),
                    !!a
                },
                e.menus[d] = h
            }
        ...
        a.createMenu(function(c) {
            ...
            if (c(e)) {
                ...
                i.updateSelectedEvent = function() {
                    ...
                    return a = f.getSelfOrParentByName(a, "span,font", d),
                    !!a
                },
                f.menus[e] = i
            }
            ...
            if (c(d)) {
                ...
                g.clickEvent = function(a) {
                    function c() {
                        ...
                        a = j.getRangeElem(),
                        e = j.getSelfOrParentByName(a, "blockquote"),
                        e && (f = b(e), g = b("<p>" + f.text() + "</p>"), f.after(g).remove()),
                        c = j.getSelfOrParentByName(a, "p,h1,h2,h3,h4,h5"),
                        c && (d = b(c), g = b("<p>" + d.text() + "</p>"), d.after(g).remove()),
                        h = j.getSelfOrParentByName(a, "ul,ol"),
                        h && (i = b(h), g = b("<p>" + i.text() + "</p>"), i.after(g).remove())
                    }
                    function d() {
                        var a = this;
    ...
    b(function(a, b) {
        a.createMenu(function(c) {
            function d() {
                var a = i.$codeTextarea,
                c = g.txt.$txt,
                d = b.trim(a.val());
                d || (d = "<p><br></p>"),
                g.config.jsFilter && (d = d.replace(/<script[\s\S]*?<\/script>/gi, ""));
                try {
                    c.html(d)
                } catch(e) {}
            }
                ...
                g.clickEventSelected = function(a) {
                    function c() {
                        ...
                        if (a = b(g), c = a.children(), c.length) return c.each(function(c) {
                            var d = b(this);
                            "P" === d.get(0).nodeName ? a.after(d) : a.after("<p>" + d.text() + "</p>"),
                            h = d
                        }),
                        void a.remove()
                    }
                    ...
                    var f, g, h;
                    return f = e.getRangeElem(),
                    (g = e.getSelfOrParentByName(f, "blockquote")) ? void e.customCommand(a, c, d) : void a.preventDefault()
                },
                g.updateSelectedEvent = function() {
                    var a, b = this,
                    c = b.editor;
                    return a = c.getRangeElem(),
                    a = c.getSelfOrParentByName(a, "blockquote"),
                    !!a
                },
                e.menus[d] = g,
                e.ready(function() {
                    ...
                    function(c) {
                        ...
                        var f = a.getRangeElem(),
                        g = b(f);
                        g.length && g.parent().after(g),
                        a.restoreSelectionByElem(f, "start"),
                        d = !1,
                        c.preventDefault()
                    })
                }),
    ...
    b(function(a, b) {
        a.createMenu(function(c) {
            ...
            if (c(d)) {
                ...
                h.updateSelectedEvent = function() {
                    var a = e.getRangeElem();
                    return a = e.getSelfOrParentByName(a, "font[face]"),
                    !!a
                },
                e.menus[d] = h
            }
        ...
        a.createMenu(function(b) {
            ...
            if (b(c)) {
                ...
                g.updateSelectedEvent = function() {
                    ...
                    return a = d.getSelfOrParentByName(a, "font[size]"),
                    !!a
                },
                d.menus[c] = g
            }
        ...
        a.createMenu(function(b) {
            ...
            if (b(e)) {
                ...
                i.updateSelectedEvent = function() {
                    ...
                    return a = g.getSelfOrParentByName(a, "h1,h2,h3,h4,h5"),
                    !!a
                },
                g.menus[e] = i
            }
    ...
    b(function(a, b) {
        a.createMenu(function(c) {
            ...
            if (c(d)) {
                ...
                g.updateSelectedEvent = function() {
                    var a = e.getRangeElem();
                    return a = e.getSelfOrParentByName(a, "p,h1,h2,h3,h4,h5,li",
                    function(a) {
                        var c;
    ...
    b(function(a, b) {
        a.createMenu(function(c) {
            ...
            if (c(d)) {
                ...
                h = b("<div></div>"),
                i = b('<div style="margin:20px 10px;" class="clearfix"></div>'),
                j = i.clone(),
                k = i.clone().css("margin", "0 10px"),
                ...
                j.append(m),
                k.append(n).append(o),
                h.append(i).append(j).append(k),
                g.dropPanel = new a.DropPanel(e, g, {
                    $content: h,
                    width: 300
                }),
                g.clickEvent = function(a) {
                    ...
                    var d = "",
                    f = e.getRangeElem();
                    f = e.getSelfOrParentByName(f, "a"),
                    f && (d = f.href || "");
                    var g = "",
                    h = e.isRangeEmpty();
                    h ? f && (g = f.textContent || f.innerHTML) : g = e.getRangeText() || "",
                    d && m.val(d),
                    g && l.val(g),
                    h ? l.removeAttr("disabled") : l.attr("disabled", !0),
                    c.show()
                },
                g.updateSelectedEvent = function() {
                    var a = e.getRangeElem();
                    return a = e.getSelfOrParentByName(a, "a"),
                    !!a
                },
                o.click(function(a) {
                    a.preventDefault(),
                ...
                n.click(function(c) {
                    c.preventDefault();
                    var d, f, h, i, j, k, n = e.getRangeElem(),
                    o = e.getSelfOrParentByName(n, "a"),
                    p = e.isRangeEmpty(),
                    q = e.txt.$txt,
                    r = "link" + a.random(),
                    s = b.trim(m.val()),
        ...
        a.createMenu(function(c) {
            ...
            if (c(d)) {
                ...
                g.clickEvent = function(a) {
                    ...
                    var g = e.getRangeElem(),
                    h = e.getSelfOrParentByName(g, "a");
                    if (!h) return void a.preventDefault();
                    var i = b(h),
                    j = b("<span>" + i.text() + "</span>");
                    e.customCommand(a, c, d)
                },
                e.menus[d] = g
            }
    ...
    b(function(a, b) {
        a.createMenu(function(c) {
            ...
            if (c(d)) {
                ...
                k.append(l),
                k.append(m).append(n).append(o).append(p),
                l.on("mouseenter", "td",
                function(a) {
                ...
                j.dropPanel = new a.DropPanel(h, j, {
                    $content: k,
                    width: 262
                }),
                h.menus[d] = j
        ...
        a.createMenu(function(c) {
            function d(a, c) {
                ...
                function(a, d) {
                    ...
                    g = d.value || d.title,
                    h = "icon" === j ? e: g,
                    i = b('<a href="#" commandValue="' + h + '"></a>'),
                    k = b("<img>");
                    k.attr("_src", e),
                    i.append(k),
                    c.append(i),
                    f.emotionUrls.push(e)
                })
            }
            var e = "emotion";
            if (c(e)) {
                ...
                function(c, e) {
                    ...
                    if (n.append(i), h.click(function(a) {
                        ...
                        h.addClass("selected"),
                        a.preventDefault()
                    }), "string" == typeof g) a.log("将通过 " + g + " 地址ajax下载表情包"),
                    b.get(g,
                    function(c) {
                        c = b.parseJSON(c),
                        a.log("下载完毕，得到 " + c.length + " 个表情"),
                        d(c, i)
                    });
                    else {
                ...
                n.children().first().addClass("selected"),
                n.on("click", "a[commandValue]",
                function(a) {
                    var c = b(a.currentTarget),
                    d = c.attr("commandValue");
                    "icon" === j ? f.command(a, "InsertImage", d) : f.command(a, "insertHtml", "<span>" + d + "</span>"),
                    a.preventDefault()
                }),
                k.dropPanel = new a.DropPanel(f, k, {
                    $content: l,
                    width: 350
                }),
                k.clickEvent = function(c) {
                    var d = this,
                    e = d.dropPanel;
    ...
    b(function(a, b) {
        function c(a, c, d) {
            ...
            var f = a.config.lang,
            g = b('<div style="margin:20px 10px 10px 10px;"></div>'),
        ...
        a.createMenu(function(d) {
            function e() {
                ...
                p.click(function(b) {
                    ...
                    p.addClass("selected"),
                    b.preventDefault(),
                    a.placeholder && r.find("input[type=text]").focus()
                }),
                o.click()
            }
            function f() {
            ...
            if (d(h)) {
                ...
                l.append(m).append(n);
                var o = b('<a href="#">' + j.uploadImg + "</a>"),
                p = b('<a href="#">' + j.linkImg + "</a>");
                m.append(o).append(p);
                ...
                n.append(r),
                c(i, k, r),
                k.dropPanel = new a.DropPanel(i, k, {
                    $content: l,
                    width: 400,
                    onRender: function() {
    ...
    b(function(a, b) {
        ...
        a.baiduMapAk = "TVhjYjq1ICT2qqL5LdS8mwas",
        a.numberOfLocation = 0,
        a.createMenu(function(d) {
            function e() {
                q.val("")
            }
            ...
            if (d(f)) {
                ...
                var k = g.mapData;
                k.markers = [],
                k.mapContainerId = "map" + a.random(),
                k.clearLocations = function() {
                    var a = k.map;
                ...
                k.searchMap = function() {
                    var a = k.map;
                    if (a) {
                        var b, c, d = window.BMap,
                        e = p.val(),
                        f = q.val();
                        "" !== e && (f && "" !== f || a.centerAndZoom(e, 11), f && "" !== f && (b = new d.Geocoder, b.getPoint(f,
                        function(b) {
                ...
                window.baiduMapCallBack = function() {
                    function b(b) {
                        ...
                        e.setCenter(d),
                        p.val(d),
                        a.placeholder && q.focus();
                        var f, g;
                        c ? (g = function(a) {
                            "keyup" === a.type && 13 === a.keyCode && a.preventDefault(),
                            f && clearTimeout(f),
                            f = setTimeout(k.searchMap, 500)
                        },
                    ...
                    if (!l) {
                        ...
                        var e = k.map;
                        e.centerAndZoom(new d.Point(116.404, 39.915), 11),
                        e.addControl(new d.MapTypeControl),
                        e.setCurrentCity("北京"),
                ...
                k.loadMapScript = function() {
                    ...
                    b.src = "https://api.map.baidu.com/api?v=2.0&ak=" + j + "&s=1&callback=baiduMapCallBack";
                    try {
                ...
                g.menus[f] = m;
                var n = b("<div></div>"),
                o = b('<div style="margin:10px 0;"></div>'),
                p = b('<input type="text"/>');
                p.css({
                    width: "80px",
                    "text-align": "center"
                ...
                q.css({
                    width: "300px",
                    "margin-left": "10px"
                }).attr("placeholder", i.searchlocation);
                var r = b('<button class="right link">' + i.clearLocation + "</button>");
                o.append(r).append(p).append(q),
                n.append(o),
                r.click(function(a) {
                    q.val(""),
                    q.focus(),
                ...
                x.append(y).append('<span style="display:inline-block;margin-left:5px;">  ' + i.dynamicMap + "</span>"),
                u.append(x).append(v).append(w),
                n.append(u),
                w.click(function(a) {
                    a.preventDefault(),
                    e(),
                ...
                v.click(function(a) {
                    ...
                    r = q.width,
                    s = q.height;
                    if (d = j ? "http://ueditor.baidu.com/ueditor/dialogs/map/show.html#": "http://api.map.baidu.com/staticimage?", d = d + "center=" + n + "," + o + "&zoom=" + p + "&width=" + r + "&height=" + s, l.length > 0 && (d += "&markers=", b.each(l,
                    function(a, b) {
                        c = b.getPosition(),
                        a > 0 && (d += "|"),
                        d = d + c.lng + "," + c.lat
                        ...
                        d += "&markerStyles=l,A",
                        f = '<iframe class="ueditor_baidumap" src="{src}" frameborder="0" width="' + r + '" height="' + s + '"></iframe>',
                        f = f.replace("{src}", d),
                        g.command(a, "insertHtml", f, e)
                    } else g.command(a, "insertHtml", '<img style="max-width:100%;" src="' + d + '"/>', e)
                }),
                m.dropPanel = new a.DropPanel(g, m, {
                    $content: n,
                    width: 500
                }),
                m.onRender = function() {
    ...
    b(function(a, b) {
        function c() {
            if (! (a.userAgent.indexOf("MSIE 8") > 0 || window.hljs)) {
                var b = document.createElement("script");
                b.type = "text/javascript",
                b.src = "//cdn.bootcss.com/highlight.js/9.2.0/highlight.min.js",
                document.body.appendChild(b)
            }
        }
        a.createMenu(function(d) {
            function e(a) {
                ...
                a.append(c);
                var d = b("<div></div>"),
                e = b('<button class="right">' + j.submit + "</button>"),
                f = b('<button class="right gray">' + j.cancel + "</button>");
                d.append(e).append(f).append(o),
                a.append(d),
                f.click(function(a) {
                    a.preventDefault(),
                    l.dropPanel.hide()
                ...
                e.click(function(a) {
                    function c() {
                        var a;
                        i && (a = q.attr("class"), a !== i + " hljs" && q.attr("class", i + " hljs")),
                        q.html(e)
                    }
                    function d() {
                        h.restoreSelectionByElem(r),
                        m()
                    }
                    a.preventDefault();
                    var e = n.val();
                    ...
                    r && (r = h.getSelfOrParentByName(f, "code")),
                    r && (q = b(r), h.customCommand(a, c, d))
                })
            }
            function f() {
                var a = h.getRangeElem(),
                b = h.getSelfOrParentByName(a, "code");
            ...
            if (d(g)) {
                ...
                l.clickEvent = function(a) {
                    ...
                    if (e && e.listLanguages) {
                        ...
                        b.each(e.listLanguages(),
                        function(a, b) {
                            "xml" === b && (b = "html"),
                            b === i.codeDefaultLang ? o.append('<option value="' + b + '" selected="selected">' + b + "</option>") : o.append('<option value="' + b + '">' + b + "</option>")
                        })
                    } else o.hide()
                },
                l.clickEventSelected = function(a) {
                    ...
                    if (d.isShowing) return void d.hide();
                    d.show();
                    var e, f, g = h.getRangeElem(),
                    i = h.getSelfOrParentByName(g, "pre");
                    i && (i = h.getSelfOrParentByName(g, "code")),
                    i && (e = b(i), n.val(e.text()), o && (f = e.attr("class"), f && o.val(f.split(" ")[0])))
                },
                l.updateSelectedEvent = function() {
                    var a, b = this,
                    c = b.editor;
                    return a = c.getRangeElem(),
                    a = c.getSelfOrParentByName(a, "pre"),
                    !!a
                };
                var m = b("<div></div>"),
                n = b("<textarea></textarea>"),
                o = b("<select></select>");
                e(m),
                l.dropPanel = new a.DropPanel(h, l, {
                    $content: m,
                    width: 500
                }),
                h.menus[g] = l,
                ...
                function(a) {
                    if (13 === a.keyCode) {
                        var b = h.getRangeElem(),
                        c = h.getSelfOrParentByName(b, "code");
        ...
        a.createMenu(function(b) {
            ...
            if (b(d)) {
                ...
                m.clickEvent = function(b) {
                    ...
                    d.addClass("wangEditor-fullscreen"),
                    e = d.css("z-index"),
                    d.css("z-index", j);
                    var i, k = h.height(),
                    m = h.outerHeight();
                    ...
                    h.height(a.$window.height() - n.height() - (m - k)),
                    g.menuContainer.$menuContainer.attr("style", ""),
                    l = !0,
                    g.isFullScreen = !0,
                ...
                m.clickEventSelected = function(b) {
                    var d = g.$editorContainer;
                    d.removeClass("wangEditor-fullscreen"),
                    d.css("z-index", e),
                    g.useMaxHeight ? h.css("max-height", f) : g.$valueContainer.css("height", g.valueContainerHeight),
                    g.txt.initHeight(),
                    l = !1,
                    g.isFullScreen = !1,
                    null != c && a.$window.scrollTop(c)
                },
    ...
    b(function(a, b) {
        a.fn.eventTxt = function() {
            var a = this.txt;
            a.saveSelectionEvent(),
            a.updateValueEvent(),
            a.updateMenuStyleEvent()
        }
    }),
    b(function(a, b) {
        a.plugin(function() {
            var b = this,
            c = b.config.uploadImgFns;
            c.onload || (c.onload = function(b, c) {
                a.log("上传结束，返回结果为 " + b);
                var d, e = this,
                f = e.uploadImgOriginalName || "";
                0 === b.indexOf("error|") ? (a.warn("上传失败：" + b.split("|")[1]), alert(b.split("|")[1])) : (a.log("上传成功，即将插入编辑区域，结果为：" + b), d = document.createElement("img"), d.onload = function() {
                    ...
                    e.command(null, "insertHtml", c),
                    a.log("已插入图片，地址 " + b),
                    d = null
                },
                d.onerror = function() {
                    a.error("使用返回的结果获取图片，发生错误。请确认以下结果是否正确：" + b),
                    d = null
                },
                d.src = b)
            }),
        ...
        window.FileReader && window.FormData && a.plugin(function() {
            ...
            h && (f.xhrUploadImg = function(g) {
                function j() {
                    ...
                    n.preventDefault(),
                    u && u.call(f, z),
                    f.hideUploadProgress()
                }
                var n = g.event,
                o = g.filename || "",
                p = g.base64,
                q = g.fileType || "image/png",
                r = g.name || "wangEditor_upload_file",
                s = g.loadfn || k,
                t = g.errorfn || m,
                u = g.timeoutfn || l,
                v = f.config.uploadParams || {},
                w = f.config.uploadHeaders || {},
                x = "png";
                if (o.indexOf(".") > 0 ? x = o.slice(o.lastIndexOf(".") - o.length + 1) : q.indexOf("/") > 0 && q.split("/")[1] && (x = q.split("/")[1]), a.isOnWebsite) return a.log("预览模拟上传"),
                void d(p, n);
                var y, z = new XMLHttpRequest,
                A = new FormData;
                z.onload = function() {
                    y && clearTimeout(y),
                    f.uploadImgOriginalName = o,
                    o.indexOf(".") > 0 && (f.uploadImgOriginalName = o.split(".")[0]),
                    s && s.call(f, z.responseText, z),
                    f.hideUploadProgress()
                },
                z.onerror = function() {
                    y && clearTimeout(y),
                ...
                z.withCredentials = f.config.withCredentials || !0,
                z.send(A),
                y = setTimeout(j, i),
                a.log("开始上传...并开始超时计算")
            })
    ...
    b(function(a, b) {
        a.plugin(function() {
            ...
            g = d.$editorContainer,
            h = g.width(),
            i = b('<div class="wangEditor-upload-progress"></div>'),
            j = !1;
    ...
    b(function(a, b) {
        if (window.FileReader && window.FormData) {
            var c = function(a) {
                this.editor = a.editor,
                this.uploadUrl = a.uploadUrl,
                this.timeout = a.timeout,
                this.fileAccept = a.fileAccept,
                this.multiple = !0
            };
            c.fn = c.prototype,
            c.fn.clear = function() {
                this.$input.val(""),
                a.log("input value 已清空")
            },
            c.fn.render = function() {
                var c = this;
                if (!c._hasRender) {
            ...
            c.fn.selected = function(c, d) {
                var e = this,
                f = d.files || [];
                0 !== f.length && (a.log("选中 " + f.length + " 个文件"), b.each(f,
                function(a, b) {
                    e.upload(b)
                }))
            },
            c.fn.upload = function(b) {
                ...
                f = b.name || "",
                g = b.type || "",
                h = e.config.uploadImgFns,
                i = e.config.uploadImgFileName || "wangEditorH5File",
                j = h.onload,
                k = h.ontimeout,
                l = h.onerror,
                m = new FileReader;
                return j && k && l ? (a.log("开始执行 " + f + " 文件的上传"), m.onload = function(b) {
                    ...
                    e.xhrUploadImg({
                        ...
                        errorfn: function(b) {
                            c(),
                            a.isOnWebsite && alert("wangEditor官网暂时没有服务端，因此报错。实际项目中不会发生");
                            var d = this;
                            l.call(d, b)
                        },
                        timeoutfn: function(b) {
                            c(),
                            a.isOnWebsite && alert("wangEditor官网暂时没有服务端，因此超时。实际项目中不会发生");
                            var d = this;
                            k(d, b)
                        }
                    })
    ...
    b(function(a, b) {
        if (!window.FileReader || !window.FormData) {
            ...
            c.fn.render = function() {
                var c = this,
                d = c.editor,
                e = d.config.uploadImgFileName || "wangEditorFormFile";
                if (!c._hasRender) {
                    var f = c.uploadUrl;
                    a.log("渲染dom");
                    ...
                    n.append(k).append(l).append(m),
                    b.each(d.config.uploadParams,
                    function(a, c) {
            ...
            c.fn.bindLoadEvent = function() {
                function a() {
                    ...
                    if (a) {
                        var e = c.$input.val(),
                        f = e;
                        e.lastIndexOf("\\") >= 0 && (f = e.slice(e.lastIndexOf("\\") + 1), f.indexOf(".") > 0 && (f = f.split(".")[0])),
                        d.uploadImgOriginalName = f,
                        h.call(d, a),
                        c.clear(),
                        c.hideModal()
                    }
                ...
                if (!c._hasBindLoad) {
                    ...
                    f.attachEvent ? f.attachEvent("onload", a) : f.onload = a,
                    c._hasBindLoad = !0
                }
            },
            c.fn.show = function() {
    ...
    b(function(a, b) {
        a.plugin(function() {
            function c() {
                var c = /^data:(image\/\w+);base64/,
                g = h.find("img");
                a.log("粘贴后，检查到编辑器有" + g.length + "个图片。开始遍历图片，试图找到刚刚粘贴过来的图片"),
                b.each(g,
                function() {
                    var g, h, i = this,
                    j = b(i),
            ...
            function(g) {
                ...
                i = null == l ? window.clipboardData && window.clipboardData.getData("text") : l.getData("text/plain") || l.getData("text/html"),
                i || (j = l && l.items, j ? (a.log("通过 data.items 得到了数据"), b.each(j,
                function(b, c) {
                    var e = c.type || "";
    ...
    b(function(a, b) {
        a.plugin(function() {
            ...
            g && (a.$document.on("dragleave drop dragenter dragover",
            function(a) {
                a.preventDefault()
            }), e.on("drop",
            function(d) {
                ...
                f = e.dataTransfer && e.dataTransfer.files;
                f && f.length && b.each(f,
                function(b, e) {
                    var f = e.type,
                    g = e.name;
    ...
    b(function(a, b) {
        a.plugin(function() {
            ...
            j = i.$txt,
            k = "",
            l = h.useMaxHeight ? j.parent() : j,
            m = !1,
            n = b('<div class="txt-toolbar"></div>'),
            ...
            function(a) {
                ...
                return c(),
                g && g.get(0) === d.get(0) ? void setTimeout(f, 100) : (g = d, e(), a.preventDefault(), void a.stopPropagation())
            }).on("click keydown scroll",
            function(a) {
                setTimeout(f, 100)
            }),
            a.$body.on("click keydown scroll",
            function(a) {
                setTimeout(f, 100)
            })
        })
    ...
    b(function(a, b) {
        a.userAgent.indexOf("MSIE 8") > 0 || a.plugin(function() {
            ...
            function f() {
                ...
                s.on("mousedown",
                function(k) {
                    j && (c = k.pageX, d = k.pageY, e = parseFloat(s.css("margin-left"), 10), f = parseFloat(s.css("margin-top"), 10), g = j.width(), i = j.height(), t.hide(), a.$document.on("mousemove._dragResizeImg", b), a.$document.on("mouseup._dragResizeImg",
                    function(b) {
                        a.$document.off("mousemove._dragResizeImg"),
                        a.$document.off("mouseup._dragResizeImg"),
                        h(),
                        s.css({
                            "margin-left": e,
                            "margin-top": f
            ...
            function g() {
                if (!k._disabled && null != j) {
                    ...
                    h < 0 ? (t.css("margin-left", "0"), u.hide()) : u.show(),
                    k.disableMenusExcept()
                }
            }
            function h() {
            ...
            function i(a) {
                var c = !1;
                return k.emotionUrls ? (b.each(k.emotionUrls,
                function(b, d) {
                    var e = !1;
            ...
            n = m.$txt,
            o = "",
            p = k.useMaxHeight ? n.parent() : n,
            q = (k.$editorContainer, ""),
            r = !1,
            s = b('<div class="img-drag-point"></div>'),
            t = b('<div class="txt-toolbar"></div>'),
            u = b('<div class="tip-triangle"></div>'),
            v = b("<div></div>"),
            w = b('<a href="#"><i class="wangeditor-menu-img-trash-o"></i></a>'),
            ...
            H = b('<button class="right gray">' + l.cancel + "</button>"),
            I = !1;
            p.on("mousedown", "img",
            function(a) {
                a.preventDefault()
        ...
        a.plugin(function() {
            ...
            function c() {
                if (f) {
                    ...
                    d = f.height(),
                    e = c + d + 5,
                    g = k.menuContainer.height(),
                    h = k.txt.$txt.outerHeight();
                    e > g + h && (e = g + h + 5),
                    n.css({
                        top: e,
                        left: b
    ...
    b(function(a, b) {
        a.plugin(function() {
            var b = this,
            c = b.config.menuFixed;
            if (c !== !1 && "number" == typeof c) {
                var d = parseFloat(a.$body.css("margin-top"), 10);
                isNaN(d) && (d = 0);
                var e = b.$editorContainer,
                f = e.offset().top,
                g = e.outerHeight(),
                h = b.menuContainer.$menuContainer,
                i = h.css("position"),
                j = h.css("top"),
                k = h.offset().top,
                l = h.outerHeight();
                ...
                a.$window.scroll(function() {
                    if (!b.isFullScreen) {
                        ...
                        n = h.width();
                        0 === k && (k = h.offset().top, f = e.offset().top, g = e.outerHeight(), l = h.outerHeight()),
                        m >= k && m + c + l + 30 < f + g ? (h.css({
                            position: "fixed",
                            top: c
                        }), h.width(n), a.$body.css({
                            "margin-top": d + l
                        }), b._isMenufixed || (b._isMenufixed = !0)) : (h.css({
                            position: i,
                            top: j
                        }), h.css("width", "100%"), a.$body.css({
                            "margin-top": d
                        }), b._isMenufixed && (b._isMenufixed = !1))
                    }
                })
            }
        })
        ...
        a.createMenu(function(c) {
            ...
            if (c(d)) {
                ...
                f.updateSelectedEvent = function() {
                    var a, c, d = e.getRangeElem(),
                    f = e.getSelfOrParentByName(d, "p");
        ...
        a.createMenu(function(c) {
            ...
            if (c(d)) {
                ...
                e.commandHooks.lineHeight = function(a) {
                    var c = e.getRangeElem(),
                    d = e.getSelfOrParentByName(c, "p,h1,h2,h3,h4,h5,pre");
    ...
    b(function(a, b) {
        a.plugin(function() {
            var c = this,
            d = c.config.customUpload;
            if (d) {
                if (c.config.uploadImgUrl) return alert("自定义上传无效，详看浏览器日志console.log"),
                void a.error("已经配置了 uploadImgUrl ，就不能再配置 customUpload ，两者冲突。将导致自定义上传无效。");
                ...
                e.append(f);
                var g = "upload" + a.random(),
                h = "upload" + a.random();
                f.attr("id", g),
                e.attr("id", h),
                c.customUploadBtnId = g,
                c.customUploadContainerId = h
            }
        })
    }),
    b(function(a, b) {
