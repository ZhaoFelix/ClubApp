...
})(jQuery, window, document); (function(a, d, b) {
    var c = function(e, g) {
        ...
        var j, n, i, w = a.createElement("style"),
        k = a.documentElement,
        v,
        p,
        u;
        ...
        m.prototype = {
            ...
            _closeOnNavClick: function() {
                if (n.closeOnNavClick) {
                    var y = j.getElementsByTagName("a"),
                    x = this;
                    t(y,
                    function(z, A) {
                        q(y[z], "click",
...
function(h, j, e) {
    ...
    if (a && f) {
        ...
        e(h).on("beforeunload.placeholder",
        function() {
            ...
            if (o.type == "password") {
                if (!r.data("placeholder-textinput")) {
                    try {
                        ...
                        s = e("<input>").prop(e.extend(i(this), {
                            "type": "text"
                        }))
                    }
...
function(c) {
    ...
    a.prototype = {
        ...
        doSelect: function(h) {
            var f = c("." + this.options.sugClass + "-item", this.$suggest),
            g = 0,
            e = f.length - 1;
            switch (h) {
            case 13:
...
function(a) {
    a.fn.togglePassword = function(c) {
        var d = a.extend(a.fn.togglePassword.defaults, c),
        b = a(this);
        a(d.el).on(d.ev,
        function() {
    ...
    c.fn[g] = function(N, E) {
        var J = 'input[type="' + q + '"], input[type="' + a + '"]',
        L = c(),
        B = function(O) {
            O.each(function() {
                var P = c(this);
        ...
        if (/^(check|uncheck|toggle|indeterminate|determinate|disable|enable|update|destroy)$/i.test(N)) {
            ...
            if (typeof N == "object" || !N) {
                ...
                N),
                G = F.handle,
                I = F.hoverClass || "hover",
                M = F.focusClass || "focus",
                K = F.activeClass || "active",
                C = !!F.labelHover,
                H = F.labelHoverClass || "hover",
                ...
                return L.each(function() {
                    ...
                    X = c(z + '[for="' + O + '"]').add(Z.closest(z)),
                    W = !!F.aria,
                    Q = g + "-" + Math.random().toString(36).substr(2, 6),
                    Y = '<div class="' + V + '" ' + (W ? 'role="' + R[t] + '" ': ""),
                    P;
                    if (W) {
                        X.each(function() {
                            Y += 'aria-labelledby="';
                    ...
                    Z.data(g, {
                        o: F,
                        s: Z.attr("style")
                    }).css(U); !! F.inheritClass && Y[p](R.className || ""); !! F.inheritID && O && Y.attr("id", g + "-" + O);
                    Y.css("position") == "static" && Y.css("position", "relative");
                    v(Z, true, r);
                    if (X.length) {
                        X.on(d + ".i mouseover.i mouseout.i " + w,
                        function(ad) {
                            var ab = ad[t],
                            ac = c(this);
                            if (!R[i]) {
                    ...
                    Z.on(d + ".i focus.i blur.i keyup.i keydown.i keypress.i",
                    function(ad) {
                        var ac = ad[t],
                        ab = ad.keyCode;
                        if (ac == d) {
                    ...
                    P.on(d + " mousedown mouseup mouseover mouseout " + w,
                    function(ad) {
                        var ac = ad[t],
                        ab = /wn|up/.test(ac) ? K: I;
                        if (!R[i]) {
                            if (ac == d) {
                                v(Z, false, true)
                            } else {
        ...
        init: function(c) {
            return this.each(function() {
                ...
                if (d.opt.cancel) {
                    ...
                    if (d.opt.cancelPlace == "left") {} else {}
                    f += (d.opt.size + g)
                }
                if (d.opt.readOnly) {
                    a.fixHint.call(d);
    ...
    a.fn.onePageNav = function(b) {
        ...
        d.getSection = function(i, g) {
            var e = "",
            h = Math.round(a(window).height() * g.scrollThreshold);
        ...
        d.init = function(g, h) {
            ...
            d.getPositions(g, h);
            a(window).bind("scroll.onePageNav",
            function() {
                f = true
            });
    ...
    c.prototype.addColor = function(f) {
        ...
        var i = e('<a href="###" class="cp-tile"></a>', {
            titile: f
        }).data("color", f).css({
    ...
    c.prototype.updateColors = function(g) {
        ...
        if (h.optional) {
            var l = e('<li><a class="cp-tile empty" href="###"></a></li>').css({
                width: h.tileSize,
                height: h.tileSize
            });
            this.$menu.append(l);
    ...
    c.prototype.setValue = function(f, i) {
        ...
        if (f) {
            ...
            this.$btn.css({
                background: h,
                color: j.contrast().toCssStr(),
                borderColor: j.luma() > 0.43 ? "#ccc": h
            });
            if (!this.colors[h]) {
                this.addColor(j)
            }
...
function(a) {
    a.fn.Huitags = function(c) {
        ...
        this.each(function() {
            ...
            a(document).on("click", ".Huitags-token",
            function() {
                a(this).remove();
                var s = "";
...
$(function() {
    $("table thead th input:checkbox").on("click",
    function() {
    ...
    a(document).ready(function() {
        ...
        function() {
            ...
            if (j < varscroll + f) {
                ...
                a(".stuckMenu").next().closest("div").css({
                    "margin-top": m + k + d + "px"
                },
                10);
...
function(d) {
    ...
    b.prototype.show = function(h) {
        ...
        this.backdrop(function() {
            ...
            j ? f.$element.find(".modal-dialog").one("bsTransitionEnd",
            function() {
    ...
    var a; (function(e) {
        ...
        function c(k, m) {
            ...
            if (j === true) {
                ...
                this._removeClass(this.tooltip_max, "hide"); ["left", "top", "width", "height"].forEach(function(i) {
                    this._removeProperty(this.trackSelection, i)
                },
                this); [this.handle1, this.handle2].forEach(function(i) {
                    this._removeProperty(i, "left");
                    this._removeProperty(i, "top")
                },
                this); [this.tooltip, this.tooltip_min, this.tooltip_max].forEach(function(i) {
                    this._removeProperty(i, "left");
                    this._removeProperty(i, "top");
        ...
        a.prototype = {
            ...
            _css: function(j, g, i) {
                if (e) {
                    ...
                    var h = g.replace(/^-ms-/, "ms-").replace(/-([\da-z])/gi,
                    function(k, l) {
        ...
        var b = {
            init: function() {
                return this.each(function() {
                    ...
                    e = "OFF",
                    n = false;
                    a.each(["size-MINI", "size-S", "size-L"],
                    function(q, r) {
                        if (g.indexOf(r) >= 0) {
                            h = r
                        }
                    ...
                    p.find("label").on("mousedown touchstart",
                    function(r) {
                        var q = a(this);
                        d = false;
                        r.preventDefault();
